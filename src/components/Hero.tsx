			...
			<section id='hero'>
				...
				<div className='mx-auto sm:px-7 px-4 max-w-screen-xl py-20 text-center flex flex-col justify-center min-h-[calc(100vh)]  z-10 relative'>
					<div className='flex flex-col justify-center bg-[var(--foreground)]/96 mx-auto rounded-lg p-10'>
						...
						<p className='text-white drop-shadow-sm text-lg max-w-[600px] mx-auto pt-4 pb-4'>
						...
						<div className='flex mx-auto gap-0 md:gap-10 items-center'>
							<Link
								...
								className='bg-[var(--primary)] py-3 px-6 md:py-6 rounded block text-center w-fit hover:bg-stone-700 text-black hover:text-white hover:shadow-lg transition duration-300'
							>
								Request a Quote
							</Link>
						</div>
